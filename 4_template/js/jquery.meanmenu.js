/*!
 * jQuery meanMenu v2.0.6.custom-4
...
//            meanScreenWidth: "1150", // set the screen width you want meanmenu to kick in at
            meanScreenWidth: "20", // set the screen width you want meanmenu to kick in at
...
//--------------------- moe :)
$('a#t-login').on("click",function(e){
   	e.preventDefault();
});
$('a#t-language').on("click",function(e){
   	e.preventDefault();
});
$( "a#cp-login-button" ).on("click",function(e) {
	e.preventDefault();
	$( "#webmail-login-form" ).dialog( "open" );
});
$( "a#webmail-login-button" ).on("click",function(e) {
	e.preventDefault();
	$( "#cp-login-form" ).dialog( "open" );
});
$( "a#lost-login-button" ).on("click",function(e) {
	e.preventDefault();
	$( "#lost-login-form" ).dialog( "open" );
});
...
//                    currentWidth = window.innerWidth || document.documentElement.clientWidth;
					mq = window.matchMedia( "(min-width: 1150px)" );
					if (mq.matches) {
						currentWidth = 30;
					} else  {
						currentWidth = 10;
